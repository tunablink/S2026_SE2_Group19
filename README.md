...
### 4.1. Sơ đồ Cấu trúc Tổng thể Hệ thống (System Architecture)
...
### 4.2. Biểu đồ Tuần tự: Luồng Học Bằng Video & Tương Tác Tính Năng (Lesson & Video Flow)
...
### 4.3. Biểu đồ Tuần tự: Luồng Đăng Nhập & Xác Thực (Authentication Flow)
